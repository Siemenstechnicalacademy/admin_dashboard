...
const sharedQuestionBank = {
    "units": [
        ...
        {
            isDynamic: true,
            template: "Convert {INCH} inch into centimetre",
            base_values: { INCH: 40 },
    ...
    "volume": [
        {
            isDynamic: true,
            template: "The perimeter of one face of a cube is {P} cm, its volume (in cm³) will be .............",
            base_values: { P: 20 },
            formula: function(base, inc) {
                const P = base.P + inc * 4;
                const side = P / 4;
            ...
            distractors: function(correctAnswer, base, inc) {
                const P = base.P + inc * 4;
                const side = P / 4;
                const d1 = (side * side).toString();
                const d2 = (P * 2).toString();
                const d3 = (side * side * side * 2).toString();
                return [d1, d2, d3];
            }
        },
    ...
    "algebra": [
        {
            ...
            formula: function(base, inc) {
                const RHS1 = base.RHS1 + inc * 2;
                const RHS2 = base.RHS2;
                const x = (RHS1 - RHS2) / 2;
                return {
                    values: { RHS1: RHS1, RHS2: RHS2 },
                    answer: x.toString()
                };
            },
            distractors: function(correctAnswer, base, inc) {
                const x = parseInt(correctAnswer);
                return [
                    (x + 1).toString(),
                    (x + 2).toString(),
                    (x + 3).toString()
    ...
    "Average": [
        {
            isDynamic: true,
            template: " The average of 3 numbers is {AVG}. If the first two numbers are {N1} and {N2} respectively, find the value of the third number.",
